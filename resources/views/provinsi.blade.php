                  ...
                  <tbody>
                    @foreach ($prov as $p)
                        <tr>
                            ...
                            <td>{{ $p->province }}</td>
                            <td>
                                <a href="{{ route('provinsi.edit',['id' => $p->id]) }}" class="btn btn-primary"><i class="fas fa-pen"></i> Edit</a>
                          ...
                          <div class="modal-dialog">
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                <p>Apakah kamu yakin ingin menghapus data provinsi <b>{{ $p->name }}</b></p>
                              </div>
                              <div class="modal-footer justify-content-between">
                                <form action="{{ route('provinsi.delete',['id' => $p->id]) }}" method="POST">
                                  @csrf
                                  @method('DELETE')
